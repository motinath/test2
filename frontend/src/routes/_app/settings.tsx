    ...
    <div className="h-full overflow-y-auto bg-[#F8F9FB] px-6 py-10">
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-6">
            {/* CARD 3: System & Backend Connection */}
            <Card className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)]">
              ...
              <div className="space-y-1">
                {/* Row: Backend URL */}
                <div className="grid grid-cols-[1.2fr_2fr_auto] items-center py-4 border-b border-slate-100 min-h-[58px]">
                  <span className="text-xs font-extrabold text-slate-400 select-none">Backend URL</span>
                  <div className="flex items-center text-xs font-black text-slate-800">
                    {editRow === "backendUrl" ? (
                      <Input
                        value={tempValue}
                        onChange={(e) => setTempValue(e.target.value)}
                        className="h-8 rounded-lg text-xs font-mono border-slate-200 max-w-[180px] bg-slate-50"
                        autoFocus
                      />
                    ) : (
                      <span className="font-mono text-[11px] text-slate-600 truncate">{backendUrl}</span>
                    )}
                    {savedRow === "backendUrl" && (
                      <Badge className="ml-2 bg-emerald-50 text-emerald-600 border-emerald-100 text-[9px]">Saved</Badge>
                    )}
                  ...
                  <div className="flex justify-end pl-2">
                    {editRow === "backendUrl" ? (
                      <div className="flex gap-1.5">
                        <button onClick={() => saveEdit("backendUrl")} className="p-1 rounded-md hover:bg-slate-100 text-emerald-600 cursor-pointer">
                          <Check className="h-3.5 w-3.5" />
                        </button>
                        <button onClick={cancelEdit} className="p-1 rounded-md hover:bg-slate-100 text-slate-400 cursor-pointer">
                          <X className="h-3.5 w-3.5" />
                      ...
                      <button onClick={() => startEdit("backendUrl", backendUrl)} className="p-1.5 rounded-lg hover:bg-slate-50 text-slate-400 hover:text-slate-700 transition-colors cursor-pointer">
                        <Pencil className="h-3.5 w-3.5" />
                      </button>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-[1.2fr_2fr_auto] items-center py-4 border-b border-slate-100 min-h-[58px]">
                  <div className="flex items-center gap-1.5 select-none">
                    ...
                    <span className="text-xs font-extrabold text-slate-400">Claude AI Key</span>
                  </div>
                  <div className="flex items-center text-xs font-black text-slate-800">
                    {editRow === "claudeKey" ? (
                      <Input
                  ...
                  <div className="flex justify-end pl-2">
                    {editRow === "claudeKey" ? (
                      <div className="flex gap-1.5">
                        <button onClick={() => saveEdit("claudeKey")} className="p-1 rounded-md hover:bg-slate-100 text-emerald-600 cursor-pointer">
                          <Check className="h-3.5 w-3.5" />
                        </button>
                        <button onClick={cancelEdit} className="p-1 rounded-md hover:bg-slate-100 text-slate-400 cursor-pointer">
                          <X className="h-3.5 w-3.5" />
                      ...
                      <button onClick={() => startEdit("claudeKey", "")} className="p-1.5 rounded-lg hover:bg-slate-50 text-slate-400 hover:text-slate-700 transition-colors cursor-pointer">
                        <Pencil className="h-3.5 w-3.5" />
                      </button>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-[1.2fr_2fr_auto] items-center py-4 last:border-0 min-h-[58px]">
                  <div className="flex items-center gap-1.5 select-none">
                    ...
                    <span className="text-xs font-extrabold text-slate-400">Auth Mode</span>
                  </div>
                  <div className="flex items-center text-xs font-black text-slate-800">
                    <Badge variant="outline" className="rounded-full text-[9px] font-black bg-accent/10 text-accent border-accent/20 select-none">
                      JWT / HS256
                    </Badge>
                  </div>
